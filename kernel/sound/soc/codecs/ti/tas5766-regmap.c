...
// 2018-03-16 wsshim
void tas5766_powerdown_request(bool enable)
{ 
	if(enable) 
 	{ 
 		printk("tas5766 power down request\n"); 
		transmit_registers(tmp_pTAS2559,registers_5766_power_down,(sizeof(registers_5766_power_down) / 2));  
 	} 
 	else 
 	{ 
 		printk("tas5766 power nomal mode request\n"); 
 		transmit_registers(tmp_pTAS2559,registers_5766_power_up,(sizeof(registers_5766_power_up) / 2));  
 	} 
}
